...
#Min Goalie Appearances for stats leaders pages | Default 33 over 82 games season.
$minGoaliesAppearances = 33;
...
define("STATS_MIN_GOALIE_APPEARENCES",$minGoaliesAppearances);
